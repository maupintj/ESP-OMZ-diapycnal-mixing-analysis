...
% %shading interp
% %colormap(flipud(CustomColormap1))
% colormap(Tu2_Vfinal)
% colorbar
% hold on
% %contour(mlat,P(:,1),mSA,linspace(min(min(mSA)),max(max(mSA)),20),'linecolor',[50 50 50]/255)
% contour(xi,(1:10:800)',SA2i(1:10:800,:),[34.7 34.75 34.85 34.95 35.15],'LineWidth',1,'linecolor',[50 50 50]/255)
% [C,H]=contour(xi,(1:10:800)',SA2i(1:10:800,:),[34.65:0.25:35.25],'LineWidth',1,'linecolor',[50 50 50]/255);
% clabel(C,H,'color',[50 50 50]/255)
% [C,H]=contour(xi,(1:10:800)',DO2i(1:10:800,:)*44.63,[22 60],'LineWidth',1,'linecolor','m');
% clabel(C,H,'color','m')
% contour(xi,(1:800)',DO2i*44.63,[5 45 10],'LineWidth',1.5,'linecolor','m');
% %contour(mlat,P(:,1),mOxi,[22 22],'LineWidth',2,'linecolor','m')
% set(gca,'YDir','reverse')
% clim([-90 90])
% [C,H]=contour(xi,(1:10:800)',PRO2i(1:10:800,:)-1000,[25.8 26.3 26.6 27 27.1 27.3],'LineWidth',1,'linecolor','w');
% clabel(C,H,'color','w')
% %contour(mlat,P(:,1),mRho,[26.3 27 27.3 ],'LineWidth',1,'linecolor','w');
% %contour(mlat,P(:,1),mTC,linspace(min(min(TC)),max(max(mTC)),20),'linecolor',[0.8500 0.3250 0.0980])
% y = [1000 1000 20 20];
% x = [-36.65 -36.35 -36.35 -36.65];
% %patch(x,y,[0 0 1]*0.8,'EdgeColor','none', 'FaceAlpha',0.7)
% %print('-dpng',fullfile(FolderName,['ZMO_ESP']),'-r400')
% xlim([-74.5 -73.2])
% f=gcf;
% %exportgraphics(f,fullfile(FolderName,['Turner_glider.png']),'Resolution',400,'BackgroundColor','white')
% 
% 