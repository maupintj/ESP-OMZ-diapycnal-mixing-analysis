...
e1_2020(QC1_2020>0)=NaN;
e2_2020(QC2_2020>0)=NaN;
Chi1_2020(QC1_2020>0)=NaN;
Chi2_2020(QC2_2020>0)=NaN;
e1_2021(QC1_2021>0)=NaN;
e2_2021(QC2_2021>0)=NaN;
Chi1_2021(QC1_2021>0)=NaN;
Chi2_2021(QC2_2021>0)=NaN;
e1_2022(QC1_2022>0)=NaN;
e2_2022(QC2_2022>0)=NaN;
Chi1_2022(QC1_2022>0)=NaN;
Chi2_2022(QC2_2022>0)=NaN;
...
f=gcf;
if sf
    exportgraphics(f,fullfile(figure_dir,['Tuepsichi_rho_JAN_QC.png']),'Resolution',400,'BackgroundColor','white')
end
...
f=gcf;
if sf
    exportgraphics(f,fullfile(figure_dir,['Tuepsichi_rho_JUL_QC.png']),'Resolution',400,'BackgroundColor','white')
end
...
f=gcf;
if sf
    exportgraphics(f,fullfile(figure_dir,['Tuepsichi_rho_OCT_QC.png']),'Resolution',400,'BackgroundColor','white')
end
